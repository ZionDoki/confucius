...
export const RPC_METHODS = {
  ...
  btwAbort: "btw/abort",
  btwDraft: "btw/draft",
  literatureConfig: "literature/config",
  literatureConfigure: "literature/configure",
  literatureTest: "literature/test",
  literatureSearch: "literature/search",
  literatureList: "literature/list",
  literatureGet: "literature/get",
  ...
  literatureBrowser: "literature/browser",
  subagentList: "subagent/list",
  subagentRead: "subagent/read",
  subagentCancel: "subagent/cancel",
  subagentRetry: "subagent/retry",
  health: "health",
